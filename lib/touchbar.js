...
export default {
  ...
  activate(state) {
    ...
    touchBarConfig.elements.map((e, i) => {
      switch(e.type) {
        case "button":
        // creating new button
          myTouchBarElements.push(new TouchBarButton({
            ...
            backgroundColor: (e.color ? e.color : null)
          }))
          break;

        case "label":
          // creating new label
          myTouchBarElements.push(new TouchBarLabel({
            label: e.label,
            textColor: e.color
          }))
          break;
        ...
        case "spacer":
          // breating new color picker
          myTouchBarElements.push(new TouchBarSpacer({
            size: e.size
          }))
          break;
      }
    ...
    const touchBar = new TouchBar(myTouchBarElements)
